...
public class Task5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask5_1);
        ans2=(EditText)findViewById(R.id.ansTask5_2);
        ans3=(EditText)findViewById(R.id.ansTask5_3);
        ans4=(EditText)findViewById(R.id.ansTask5_4);
        ans5=(EditText)findViewById(R.id.ansTask5_5);
        ans6=(EditText)findViewById(R.id.ansTask5_6);
        ans7=(EditText)findViewById(R.id.ansTask5_7);
        ans8=(EditText)findViewById(R.id.ansTask5_8);
        ans9=(EditText)findViewById(R.id.ansTask5_9);
        ans10=(EditText)findViewById(R.id.ansTask5_10);
        ans11=(EditText)findViewById(R.id.ansTask5_11);
        ans12=(EditText)findViewById(R.id.ansTask5_12);
        ans13=(EditText)findViewById(R.id.ansTask5_13);
        ans14=(EditText)findViewById(R.id.ansTask5_14);
        ans15=(EditText)findViewById(R.id.ansTask5_15);
        ans16=(EditText)findViewById(R.id.ansTask5_16);
        ans17=(EditText)findViewById(R.id.ansTask5_17);
        ans18=(EditText)findViewById(R.id.ansTask5_18);
        ans19=(EditText)findViewById(R.id.ansTask5_19);
        ans20=(EditText)findViewById(R.id.ansTask5_20);

        task1=(TextView)findViewById(R.id.task5_1);
        task2=(TextView)findViewById(R.id.task5_2);
        task3=(TextView)findViewById(R.id.task5_3);
        task4=(TextView)findViewById(R.id.task5_4);
        task5=(TextView)findViewById(R.id.task5_5);
        task6=(TextView)findViewById(R.id.task5_6);
        task7=(TextView)findViewById(R.id.task5_7);
        task8=(TextView)findViewById(R.id.task5_8);
        task9=(TextView)findViewById(R.id.task5_9);
        task10=(TextView)findViewById(R.id.task5_10);
        task11=(TextView)findViewById(R.id.task5_11);
        task12=(TextView)findViewById(R.id.task5_12);
        task13=(TextView)findViewById(R.id.task5_13);
        task14=(TextView)findViewById(R.id.task5_14);
        task15=(TextView)findViewById(R.id.task5_15);
        task16=(TextView)findViewById(R.id.task5_16);
        task17=(TextView)findViewById(R.id.task5_17);
        task18=(TextView)findViewById(R.id.task5_18);
        task19=(TextView)findViewById(R.id.task5_19);
        task20=(TextView)findViewById(R.id.task5_20);
        ...
        trueAns1=getString(R.string.answerTask5_1);
        trueAns2=getString(R.string.answerTask5_2);
        trueAns3=getString(R.string.answerTask5_3);
        trueAns4=getString(R.string.answerTask5_4);
        trueAns5=getString(R.string.answerTask5_5);
        trueAns6=getString(R.string.answerTask5_6);
        trueAns7=getString(R.string.answerTask5_7);
        trueAns8=getString(R.string.answerTask5_8);
        trueAns9=getString(R.string.answerTask5_9);
        trueAns10=getString(R.string.answerTask5_10);
        trueAns11=getString(R.string.answerTask5_11);
        trueAns12=getString(R.string.answerTask5_12);
        trueAns13=getString(R.string.answerTask5_13);
        trueAns14=getString(R.string.answerTask5_14);
        trueAns15=getString(R.string.answerTask5_15);
        trueAns16=getString(R.string.answerTask5_16);
        trueAns17=getString(R.string.answerTask5_17);
        trueAns18=getString(R.string.answerTask5_18);
        trueAns19=getString(R.string.answerTask5_19);
        trueAns20=getString(R.string.answerTask5_20);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task5Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task5Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
