...
public class Task4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button check31, check32;
    ...
    private EditText ans25, ans26, ans27, ans28, ans29, ans30, ans31, ans32;
    ...
    private TextView task31, task32;
    ...
    private String trueAns31;
    private String trueAns32;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check31=(Button)findViewById(R.id.btnCheck31);
        check32=(Button)findViewById(R.id.btnCheck32);

        ans1=(EditText)findViewById(R.id.ansTask4_1);
        ans2=(EditText)findViewById(R.id.ansTask4_2);
        ans3=(EditText)findViewById(R.id.ansTask4_3);
        ans4=(EditText)findViewById(R.id.ansTask4_4);
        ans5=(EditText)findViewById(R.id.ansTask4_5);
        ans6=(EditText)findViewById(R.id.ansTask4_6);
        ans7=(EditText)findViewById(R.id.ansTask4_7);
        ans8=(EditText)findViewById(R.id.ansTask4_8);
        ans9=(EditText)findViewById(R.id.ansTask4_9);
        ans10=(EditText)findViewById(R.id.ansTask4_10);
        ans11=(EditText)findViewById(R.id.ansTask4_11);
        ans12=(EditText)findViewById(R.id.ansTask4_12);
        ans13=(EditText)findViewById(R.id.ansTask4_13);
        ans14=(EditText)findViewById(R.id.ansTask4_14);
        ans15=(EditText)findViewById(R.id.ansTask4_15);
        ans16=(EditText)findViewById(R.id.ansTask4_16);
        ans17=(EditText)findViewById(R.id.ansTask4_17);
        ans18=(EditText)findViewById(R.id.ansTask4_18);
        ans19=(EditText)findViewById(R.id.ansTask4_19);
        ans20=(EditText)findViewById(R.id.ansTask4_20);
        ans21=(EditText)findViewById(R.id.ansTask4_21);
        ans22=(EditText)findViewById(R.id.ansTask4_22);
        ans23=(EditText)findViewById(R.id.ansTask4_23);
        ans24=(EditText)findViewById(R.id.ansTask4_24);
        ans25=(EditText)findViewById(R.id.ansTask4_25);
        ans26=(EditText)findViewById(R.id.ansTask4_26);
        ans27=(EditText)findViewById(R.id.ansTask4_27);
        ans28=(EditText)findViewById(R.id.ansTask4_28);
        ans29=(EditText)findViewById(R.id.ansTask4_29);
        ans30=(EditText)findViewById(R.id.ansTask4_30);
        ans31=(EditText)findViewById(R.id.ansTask4_31);
        ans32=(EditText)findViewById(R.id.ansTask4_32);

        task1=(TextView)findViewById(R.id.task4_1);
        task2=(TextView)findViewById(R.id.task4_2);
        task3=(TextView)findViewById(R.id.task4_3);
        task4=(TextView)findViewById(R.id.task4_4);
        task5=(TextView)findViewById(R.id.task4_5);
        task6=(TextView)findViewById(R.id.task4_6);
        task7=(TextView)findViewById(R.id.task4_7);
        task8=(TextView)findViewById(R.id.task4_8);
        task9=(TextView)findViewById(R.id.task4_9);
        task10=(TextView)findViewById(R.id.task4_10);
        task11=(TextView)findViewById(R.id.task4_11);
        task12=(TextView)findViewById(R.id.task4_12);
        task13=(TextView)findViewById(R.id.task4_13);
        task14=(TextView)findViewById(R.id.task4_14);
        task15=(TextView)findViewById(R.id.task4_15);
        task16=(TextView)findViewById(R.id.task4_16);
        task17=(TextView)findViewById(R.id.task4_17);
        task18=(TextView)findViewById(R.id.task4_18);
        task19=(TextView)findViewById(R.id.task4_19);
        task20=(TextView)findViewById(R.id.task4_20);
        task21=(TextView)findViewById(R.id.task4_21);
        task22=(TextView)findViewById(R.id.task4_22);
        task23=(TextView)findViewById(R.id.task4_23);
        task24=(TextView)findViewById(R.id.task4_24);
        task25=(TextView)findViewById(R.id.task4_25);
        task26=(TextView)findViewById(R.id.task4_26);
        task27=(TextView)findViewById(R.id.task4_27);
        task28=(TextView)findViewById(R.id.task4_28);
        task29=(TextView)findViewById(R.id.task4_29);
        task30=(TextView)findViewById(R.id.task4_30);
        task31=(TextView)findViewById(R.id.task4_31);
        task32=(TextView)findViewById(R.id.task4_32);
        ...
        check31.setOnClickListener(this);
        check32.setOnClickListener(this);

        trueAns1=getString(R.string.answerTask4_1);
        trueAns2=getString(R.string.answerTask4_2);
        trueAns3=getString(R.string.answerTask4_3);
        trueAns4=getString(R.string.answerTask4_4);
        trueAns5=getString(R.string.answerTask4_5);
        trueAns6=getString(R.string.answerTask4_6);
        trueAns7=getString(R.string.answerTask4_7);
        trueAns8=getString(R.string.answerTask4_8);
        trueAns9=getString(R.string.answerTask4_9);
        trueAns10=getString(R.string.answerTask4_10);
        trueAns11=getString(R.string.answerTask4_11);
        trueAns12=getString(R.string.answerTask4_12);
        trueAns13=getString(R.string.answerTask4_13);
        trueAns14=getString(R.string.answerTask4_14);
        trueAns15=getString(R.string.answerTask4_15);
        trueAns16=getString(R.string.answerTask4_16);
        trueAns17=getString(R.string.answerTask4_17);
        trueAns18=getString(R.string.answerTask4_18);
        trueAns19=getString(R.string.answerTask4_19);
        trueAns20=getString(R.string.answerTask4_20);
        trueAns21=getString(R.string.answerTask4_21);
        trueAns22=getString(R.string.answerTask4_22);
        trueAns23=getString(R.string.answerTask4_23);
        trueAns24=getString(R.string.answerTask4_24);
        trueAns25=getString(R.string.answerTask4_25);
        trueAns26=getString(R.string.answerTask4_26);
        trueAns27=getString(R.string.answerTask4_27);
        trueAns28=getString(R.string.answerTask4_28);
        trueAns29=getString(R.string.answerTask4_29);
        trueAns30=getString(R.string.answerTask4_30);
        trueAns31=getString(R.string.answerTask4_31);
        trueAns32=getString(R.string.answerTask4_32);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if(ans1.getText().toString().equals(trueAns1)){
                    ...
                    Toast.makeText(Task4Activity.this,"true",Toast.LENGTH_LONG).show();
                }
                else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task4Activity.this,"wrong",Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
            ...
            case R.id.btnCheck30:
                ...
                break;
            case R.id.btnCheck31:
                if(ans31.getText().toString().equals(trueAns31)){
                    task31.setTextColor(getResources().getColor(R.color.colorGreen));
                    Toast.makeText(Task4Activity.this,"true",Toast.LENGTH_LONG).show();
                }
                else {
                    task31.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task4Activity.this,"wrong",Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck32:
                if(ans32.getText().toString().equals(trueAns32)){
                    task32.setTextColor(getResources().getColor(R.color.colorGreen));
                    Toast.makeText(Task4Activity.this,"true",Toast.LENGTH_LONG).show();
                }
                else {
                    task32.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task4Activity.this,"wrong",Toast.LENGTH_LONG).show();
                }
                break;
        }
