...
public class Task9Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask9_1);
        ans2=(EditText)findViewById(R.id.ansTask9_2);
        ans3=(EditText)findViewById(R.id.ansTask9_3);
        ans4=(EditText)findViewById(R.id.ansTask9_4);
        ans5=(EditText)findViewById(R.id.ansTask9_5);
        ans6=(EditText)findViewById(R.id.ansTask9_6);
        ans7=(EditText)findViewById(R.id.ansTask9_7);
        ans8=(EditText)findViewById(R.id.ansTask9_8);
        ans9=(EditText)findViewById(R.id.ansTask9_9);
        ans10=(EditText)findViewById(R.id.ansTask9_10);
        ans11=(EditText)findViewById(R.id.ansTask9_11);
        ans12=(EditText)findViewById(R.id.ansTask9_12);
        ans13=(EditText)findViewById(R.id.ansTask9_13);
        ans14=(EditText)findViewById(R.id.ansTask9_14);
        ans15=(EditText)findViewById(R.id.ansTask9_15);
        ans16=(EditText)findViewById(R.id.ansTask9_16);
        ans17=(EditText)findViewById(R.id.ansTask9_17);
        ans18=(EditText)findViewById(R.id.ansTask9_18);
        ans19=(EditText)findViewById(R.id.ansTask9_19);
        ans20=(EditText)findViewById(R.id.ansTask9_20);

        task1=(TextView)findViewById(R.id.task9_1);
        task2=(TextView)findViewById(R.id.task9_2);
        task3=(TextView)findViewById(R.id.task9_3);
        task4=(TextView)findViewById(R.id.task9_4);
        task5=(TextView)findViewById(R.id.task9_5);
        task6=(TextView)findViewById(R.id.task9_6);
        task7=(TextView)findViewById(R.id.task9_7);
        task8=(TextView)findViewById(R.id.task9_8);
        task9=(TextView)findViewById(R.id.task9_9);
        task10=(TextView)findViewById(R.id.task9_10);
        task11=(TextView)findViewById(R.id.task9_11);
        task12=(TextView)findViewById(R.id.task9_12);
        task13=(TextView)findViewById(R.id.task9_13);
        task14=(TextView)findViewById(R.id.task9_14);
        task15=(TextView)findViewById(R.id.task9_15);
        task16=(TextView)findViewById(R.id.task9_16);
        task17=(TextView)findViewById(R.id.task9_17);
        task18=(TextView)findViewById(R.id.task9_18);
        task19=(TextView)findViewById(R.id.task9_19);
        task20=(TextView)findViewById(R.id.task9_20);
        ...
        trueAns1=getString(R.string.answerTask9_1);
        trueAns2=getString(R.string.answerTask9_2);
        trueAns3=getString(R.string.answerTask9_3);
        trueAns4=getString(R.string.answerTask9_4);
        trueAns5=getString(R.string.answerTask9_5);
        trueAns6=getString(R.string.answerTask9_6);
        trueAns7=getString(R.string.answerTask9_7);
        trueAns8=getString(R.string.answerTask9_8);
        trueAns9=getString(R.string.answerTask9_9);
        trueAns10=getString(R.string.answerTask9_10);
        trueAns11=getString(R.string.answerTask9_11);
        trueAns12=getString(R.string.answerTask9_12);
        trueAns13=getString(R.string.answerTask9_13);
        trueAns14=getString(R.string.answerTask9_14);
        trueAns15=getString(R.string.answerTask9_15);
        trueAns16=getString(R.string.answerTask9_16);
        trueAns17=getString(R.string.answerTask9_17);
        trueAns18=getString(R.string.answerTask9_18);
        trueAns19=getString(R.string.answerTask9_19);
        trueAns20=getString(R.string.answerTask9_20);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task9Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task9Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
