...
public class Task6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask6_1);
        ans2=(EditText)findViewById(R.id.ansTask6_2);
        ans3=(EditText)findViewById(R.id.ansTask6_3);
        ans4=(EditText)findViewById(R.id.ansTask6_4);
        ans5=(EditText)findViewById(R.id.ansTask6_5);
        ans6=(EditText)findViewById(R.id.ansTask6_6);
        ans7=(EditText)findViewById(R.id.ansTask6_7);
        ans8=(EditText)findViewById(R.id.ansTask6_8);
        ans9=(EditText)findViewById(R.id.ansTask6_9);
        ans10=(EditText)findViewById(R.id.ansTask6_10);
        ans11=(EditText)findViewById(R.id.ansTask6_11);
        ans12=(EditText)findViewById(R.id.ansTask6_12);
        ans13=(EditText)findViewById(R.id.ansTask6_13);
        ans14=(EditText)findViewById(R.id.ansTask6_14);
        ans15=(EditText)findViewById(R.id.ansTask6_15);
        ans16=(EditText)findViewById(R.id.ansTask6_16);
        ans17=(EditText)findViewById(R.id.ansTask6_17);
        ans18=(EditText)findViewById(R.id.ansTask6_18);
        ans19=(EditText)findViewById(R.id.ansTask6_19);
        ans20=(EditText)findViewById(R.id.ansTask6_20);
        ans21=(EditText)findViewById(R.id.ansTask6_21);
        ans22=(EditText)findViewById(R.id.ansTask6_22);
        ans23=(EditText)findViewById(R.id.ansTask6_23);
        ans24=(EditText)findViewById(R.id.ansTask6_24);
        ans25=(EditText)findViewById(R.id.ansTask6_25);
        ans26=(EditText)findViewById(R.id.ansTask6_26);
        ans27=(EditText)findViewById(R.id.ansTask6_27);
        ans28=(EditText)findViewById(R.id.ansTask6_28);
        ans29=(EditText)findViewById(R.id.ansTask6_29);
        ans30=(EditText)findViewById(R.id.ansTask6_30);

        task1=(TextView)findViewById(R.id.task6_1);
        task2=(TextView)findViewById(R.id.task6_2);
        task3=(TextView)findViewById(R.id.task6_3);
        task4=(TextView)findViewById(R.id.task6_4);
        task5=(TextView)findViewById(R.id.task6_5);
        task6=(TextView)findViewById(R.id.task6_6);
        task7=(TextView)findViewById(R.id.task6_7);
        task8=(TextView)findViewById(R.id.task6_8);
        task9=(TextView)findViewById(R.id.task6_9);
        task10=(TextView)findViewById(R.id.task6_10);
        task11=(TextView)findViewById(R.id.task6_11);
        task12=(TextView)findViewById(R.id.task6_12);
        task13=(TextView)findViewById(R.id.task6_13);
        task14=(TextView)findViewById(R.id.task6_14);
        task15=(TextView)findViewById(R.id.task6_15);
        task16=(TextView)findViewById(R.id.task6_16);
        task17=(TextView)findViewById(R.id.task6_17);
        task18=(TextView)findViewById(R.id.task6_18);
        task19=(TextView)findViewById(R.id.task6_19);
        task20=(TextView)findViewById(R.id.task6_20);
        task21=(TextView)findViewById(R.id.task6_21);
        task22=(TextView)findViewById(R.id.task6_22);
        task23=(TextView)findViewById(R.id.task6_23);
        task24=(TextView)findViewById(R.id.task6_24);
        task25=(TextView)findViewById(R.id.task6_25);
        task26=(TextView)findViewById(R.id.task6_26);
        task27=(TextView)findViewById(R.id.task6_27);
        task28=(TextView)findViewById(R.id.task6_28);
        task29=(TextView)findViewById(R.id.task6_29);
        task30=(TextView)findViewById(R.id.task6_30);
        ...
        trueAns1=getString(R.string.answerTask6_1);
        trueAns2=getString(R.string.answerTask6_2);
        trueAns3=getString(R.string.answerTask6_3);
        trueAns4=getString(R.string.answerTask6_4);
        trueAns5=getString(R.string.answerTask6_5);
        trueAns6=getString(R.string.answerTask6_6);
        trueAns7=getString(R.string.answerTask6_7);
        trueAns8=getString(R.string.answerTask6_8);
        trueAns9=getString(R.string.answerTask6_9);
        trueAns10=getString(R.string.answerTask6_10);
        trueAns11=getString(R.string.answerTask6_11);
        trueAns12=getString(R.string.answerTask6_12);
        trueAns13=getString(R.string.answerTask6_13);
        trueAns14=getString(R.string.answerTask6_14);
        trueAns15=getString(R.string.answerTask6_15);
        trueAns16=getString(R.string.answerTask6_16);
        trueAns17=getString(R.string.answerTask6_17);
        trueAns18=getString(R.string.answerTask6_18);
        trueAns19=getString(R.string.answerTask6_19);
        trueAns20=getString(R.string.answerTask6_20);
        trueAns21=getString(R.string.answerTask6_21);
        trueAns22=getString(R.string.answerTask6_22);
        trueAns23=getString(R.string.answerTask6_23);
        trueAns24=getString(R.string.answerTask6_24);
        trueAns25=getString(R.string.answerTask6_25);
        trueAns26=getString(R.string.answerTask6_26);
        trueAns27=getString(R.string.answerTask6_27);
        trueAns28=getString(R.string.answerTask6_28);
        trueAns29=getString(R.string.answerTask6_29);
        trueAns30=getString(R.string.answerTask6_30);
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task6Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task6Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
