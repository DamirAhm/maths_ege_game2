...
public class Task12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask12_1);
        ans2=(EditText)findViewById(R.id.ansTask12_2);
        ans3=(EditText)findViewById(R.id.ansTask12_3);
        ans4=(EditText)findViewById(R.id.ansTask12_4);
        ans5=(EditText)findViewById(R.id.ansTask12_5);
        ans6=(EditText)findViewById(R.id.ansTask12_6);
        ans7=(EditText)findViewById(R.id.ansTask12_7);
        ans8=(EditText)findViewById(R.id.ansTask12_8);
        ans9=(EditText)findViewById(R.id.ansTask12_9);
        ans10=(EditText)findViewById(R.id.ansTask12_10);
        ans11=(EditText)findViewById(R.id.ansTask12_11);
        ans12=(EditText)findViewById(R.id.ansTask12_12);
        ans13=(EditText)findViewById(R.id.ansTask12_13);
        ans14=(EditText)findViewById(R.id.ansTask12_14);
        ans15=(EditText)findViewById(R.id.ansTask12_15);
        ans16=(EditText)findViewById(R.id.ansTask12_16);
        ans17=(EditText)findViewById(R.id.ansTask12_17);
        ans18=(EditText)findViewById(R.id.ansTask12_18);
        ans19=(EditText)findViewById(R.id.ansTask12_19);
        ans20=(EditText)findViewById(R.id.ansTask12_20);

        task1=(TextView)findViewById(R.id.task12_1);
        task2=(TextView)findViewById(R.id.task12_2);
        task3=(TextView)findViewById(R.id.task12_3);
        task4=(TextView)findViewById(R.id.task12_4);
        task5=(TextView)findViewById(R.id.task12_5);
        task6=(TextView)findViewById(R.id.task12_6);
        task7=(TextView)findViewById(R.id.task12_7);
        task8=(TextView)findViewById(R.id.task12_8);
        task9=(TextView)findViewById(R.id.task12_9);
        task10=(TextView)findViewById(R.id.task12_10);
        task11=(TextView)findViewById(R.id.task12_11);
        task12=(TextView)findViewById(R.id.task12_12);
        task13=(TextView)findViewById(R.id.task12_13);
        task14=(TextView)findViewById(R.id.task12_14);
        task15=(TextView)findViewById(R.id.task12_15);
        task16=(TextView)findViewById(R.id.task12_16);
        task17=(TextView)findViewById(R.id.task12_17);
        task18=(TextView)findViewById(R.id.task12_18);
        task19=(TextView)findViewById(R.id.task12_19);
        task20=(TextView)findViewById(R.id.task12_20);
        ...
        trueAns1=getString(R.string.answerTask12_1);
        trueAns2=getString(R.string.answerTask12_2);
        trueAns3=getString(R.string.answerTask12_3);
        trueAns4=getString(R.string.answerTask12_4);
        trueAns5=getString(R.string.answerTask12_5);
        trueAns6=getString(R.string.answerTask12_6);
        trueAns7=getString(R.string.answerTask12_7);
        trueAns8=getString(R.string.answerTask12_8);
        trueAns9=getString(R.string.answerTask12_9);
        trueAns10=getString(R.string.answerTask12_10);
        trueAns11=getString(R.string.answerTask12_11);
        trueAns12=getString(R.string.answerTask12_12);
        trueAns13=getString(R.string.answerTask12_13);
        trueAns14=getString(R.string.answerTask12_14);
        trueAns15=getString(R.string.answerTask12_15);
        trueAns16=getString(R.string.answerTask12_16);
        trueAns17=getString(R.string.answerTask12_17);
        trueAns18=getString(R.string.answerTask12_18);
        trueAns19=getString(R.string.answerTask12_19);
        trueAns20=getString(R.string.answerTask12_20);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task12Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task12Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
