...
public class Task2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask2_1);
        ans2=(EditText)findViewById(R.id.ansTask2_2);
        ans3=(EditText)findViewById(R.id.ansTask2_3);
        ans4=(EditText)findViewById(R.id.ansTask2_4);
        ans5=(EditText)findViewById(R.id.ansTask2_5);
        ans6=(EditText)findViewById(R.id.ansTask2_6);
        ans7=(EditText)findViewById(R.id.ansTask2_7);
        ans8=(EditText)findViewById(R.id.ansTask2_8);
        ans9=(EditText)findViewById(R.id.ansTask2_9);
        ans10=(EditText)findViewById(R.id.ansTask2_10);
        ans11=(EditText)findViewById(R.id.ansTask2_11);
        ans12=(EditText)findViewById(R.id.ansTask2_12);
        ans13=(EditText)findViewById(R.id.ansTask2_13);
        ans14=(EditText)findViewById(R.id.ansTask2_14);
        ans15=(EditText)findViewById(R.id.ansTask2_15);
        ans16=(EditText)findViewById(R.id.ansTask2_16);
        ans17=(EditText)findViewById(R.id.ansTask2_17);
        ans18=(EditText)findViewById(R.id.ansTask2_18);
        ans19=(EditText)findViewById(R.id.ansTask2_19);
        ans20=(EditText)findViewById(R.id.ansTask2_20);

        task1=(TextView)findViewById(R.id.task2_1);
        task2=(TextView)findViewById(R.id.task2_2);
        task3=(TextView)findViewById(R.id.task2_3);
        task4=(TextView)findViewById(R.id.task2_4);
        task5=(TextView)findViewById(R.id.task2_5);
        task6=(TextView)findViewById(R.id.task2_6);
        task7=(TextView)findViewById(R.id.task2_7);
        task8=(TextView)findViewById(R.id.task2_8);
        task9=(TextView)findViewById(R.id.task2_9);
        task10=(TextView)findViewById(R.id.task2_10);
        task11=(TextView)findViewById(R.id.task2_11);
        task12=(TextView)findViewById(R.id.task2_12);
        task13=(TextView)findViewById(R.id.task2_13);
        task14=(TextView)findViewById(R.id.task2_14);
        task15=(TextView)findViewById(R.id.task2_15);
        task16=(TextView)findViewById(R.id.task2_16);
        task17=(TextView)findViewById(R.id.task2_17);
        task18=(TextView)findViewById(R.id.task2_18);
        task19=(TextView)findViewById(R.id.task2_19);
        task20=(TextView)findViewById(R.id.task2_20);
        ...
        trueAns1=getString(R.string.answerTask2_1);
        trueAns2=getString(R.string.answerTask2_2);
        trueAns3=getString(R.string.answerTask2_3);
        trueAns4=getString(R.string.answerTask2_4);
        trueAns5=getString(R.string.answerTask2_5);
        trueAns6=getString(R.string.answerTask2_6);
        trueAns7=getString(R.string.answerTask2_7);
        trueAns8=getString(R.string.answerTask2_8);
        trueAns9=getString(R.string.answerTask2_9);
        trueAns10=getString(R.string.answerTask2_10);
        trueAns11=getString(R.string.answerTask2_11);
        trueAns12=getString(R.string.answerTask2_12);
        trueAns13=getString(R.string.answerTask2_13);
        trueAns14=getString(R.string.answerTask2_14);
        trueAns15=getString(R.string.answerTask2_15);
        trueAns16=getString(R.string.answerTask2_16);
        trueAns17=getString(R.string.answerTask2_17);
        trueAns18=getString(R.string.answerTask2_18);
        trueAns19=getString(R.string.answerTask2_19);
        trueAns20=getString(R.string.answerTask2_20);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task2Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task2Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
