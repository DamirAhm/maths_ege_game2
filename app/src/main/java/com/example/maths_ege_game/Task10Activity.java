...
public class Task10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask10_1);
        ans2=(EditText)findViewById(R.id.ansTask10_2);
        ans3=(EditText)findViewById(R.id.ansTask10_3);
        ans4=(EditText)findViewById(R.id.ansTask10_4);
        ans5=(EditText)findViewById(R.id.ansTask10_5);
        ans6=(EditText)findViewById(R.id.ansTask10_6);
        ans7=(EditText)findViewById(R.id.ansTask10_7);
        ans8=(EditText)findViewById(R.id.ansTask10_8);
        ans9=(EditText)findViewById(R.id.ansTask10_9);
        ans10=(EditText)findViewById(R.id.ansTask10_10);
        ans11=(EditText)findViewById(R.id.ansTask10_11);
        ans12=(EditText)findViewById(R.id.ansTask10_12);
        ans13=(EditText)findViewById(R.id.ansTask10_13);
        ans14=(EditText)findViewById(R.id.ansTask10_14);
        ans15=(EditText)findViewById(R.id.ansTask10_15);
        ans16=(EditText)findViewById(R.id.ansTask10_16);
        ans17=(EditText)findViewById(R.id.ansTask10_17);
        ans18=(EditText)findViewById(R.id.ansTask10_18);
        ans19=(EditText)findViewById(R.id.ansTask10_19);
        ans20=(EditText)findViewById(R.id.ansTask10_20);

        task1=(TextView)findViewById(R.id.task10_1);
        task2=(TextView)findViewById(R.id.task10_2);
        task3=(TextView)findViewById(R.id.task10_3);
        task4=(TextView)findViewById(R.id.task10_4);
        task5=(TextView)findViewById(R.id.task10_5);
        task6=(TextView)findViewById(R.id.task10_6);
        task7=(TextView)findViewById(R.id.task10_7);
        task8=(TextView)findViewById(R.id.task10_8);
        task9=(TextView)findViewById(R.id.task10_9);
        task10=(TextView)findViewById(R.id.task10_10);
        task11=(TextView)findViewById(R.id.task10_11);
        task12=(TextView)findViewById(R.id.task10_12);
        task13=(TextView)findViewById(R.id.task10_13);
        task14=(TextView)findViewById(R.id.task10_14);
        task15=(TextView)findViewById(R.id.task10_15);
        task16=(TextView)findViewById(R.id.task10_16);
        task17=(TextView)findViewById(R.id.task10_17);
        task18=(TextView)findViewById(R.id.task10_18);
        task19=(TextView)findViewById(R.id.task10_19);
        task20=(TextView)findViewById(R.id.task10_20);
        ...
        trueAns1=getString(R.string.answerTask10_1);
        trueAns2=getString(R.string.answerTask10_2);
        trueAns3=getString(R.string.answerTask10_3);
        trueAns4=getString(R.string.answerTask10_4);
        trueAns5=getString(R.string.answerTask10_5);
        trueAns6=getString(R.string.answerTask10_6);
        trueAns7=getString(R.string.answerTask10_7);
        trueAns8=getString(R.string.answerTask10_8);
        trueAns9=getString(R.string.answerTask10_9);
        trueAns10=getString(R.string.answerTask10_10);
        trueAns11=getString(R.string.answerTask10_11);
        trueAns12=getString(R.string.answerTask10_12);
        trueAns13=getString(R.string.answerTask10_13);
        trueAns14=getString(R.string.answerTask10_14);
        trueAns15=getString(R.string.answerTask10_15);
        trueAns16=getString(R.string.answerTask10_16);
        trueAns17=getString(R.string.answerTask10_17);
        trueAns18=getString(R.string.answerTask10_18);
        trueAns19=getString(R.string.answerTask10_19);
        trueAns20=getString(R.string.answerTask10_20);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task10Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task10Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
