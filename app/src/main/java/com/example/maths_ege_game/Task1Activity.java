...
public class Task1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask1_1);
        ans2=(EditText)findViewById(R.id.ansTask1_2);
        ans3=(EditText)findViewById(R.id.ansTask1_3);
        ans4=(EditText)findViewById(R.id.ansTask1_4);
        ans5=(EditText)findViewById(R.id.ansTask1_5);
        ans6=(EditText)findViewById(R.id.ansTask1_6);
        ans7=(EditText)findViewById(R.id.ansTask1_7);
        ans8=(EditText)findViewById(R.id.ansTask1_8);
        ans9=(EditText)findViewById(R.id.ansTask1_9);
        ans10=(EditText)findViewById(R.id.ansTask1_10);
        ans11=(EditText)findViewById(R.id.ansTask1_11);
        ans12=(EditText)findViewById(R.id.ansTask1_12);
        ans13=(EditText)findViewById(R.id.ansTask1_13);
        ans14=(EditText)findViewById(R.id.ansTask1_14);
        ans15=(EditText)findViewById(R.id.ansTask1_15);
        ans16=(EditText)findViewById(R.id.ansTask1_16);
        ans17=(EditText)findViewById(R.id.ansTask1_17);
        ans18=(EditText)findViewById(R.id.ansTask1_18);
        ans19=(EditText)findViewById(R.id.ansTask1_19);
        ans20=(EditText)findViewById(R.id.ansTask1_20);
        ans21=(EditText)findViewById(R.id.ansTask1_21);
        ans22=(EditText)findViewById(R.id.ansTask1_22);
        ans23=(EditText)findViewById(R.id.ansTask1_23);
        ans24=(EditText)findViewById(R.id.ansTask1_24);
        ans25=(EditText)findViewById(R.id.ansTask1_25);
        ans26=(EditText)findViewById(R.id.ansTask1_26);
        ans27=(EditText)findViewById(R.id.ansTask1_27);
        ans28=(EditText)findViewById(R.id.ansTask1_28);
        ans29=(EditText)findViewById(R.id.ansTask1_29);
        ans30=(EditText)findViewById(R.id.ansTask1_30);
        ans31=(EditText)findViewById(R.id.ansTask1_31);
        ans32=(EditText)findViewById(R.id.ansTask1_32);

        task1=(TextView)findViewById(R.id.task1_1);
        task2=(TextView)findViewById(R.id.task1_2);
        task3=(TextView)findViewById(R.id.task1_3);
        task4=(TextView)findViewById(R.id.task1_4);
        task5=(TextView)findViewById(R.id.task1_5);
        task6=(TextView)findViewById(R.id.task1_6);
        task7=(TextView)findViewById(R.id.task1_7);
        task8=(TextView)findViewById(R.id.task1_8);
        task9=(TextView)findViewById(R.id.task1_9);
        task10=(TextView)findViewById(R.id.task1_10);
        task11=(TextView)findViewById(R.id.task1_11);
        task12=(TextView)findViewById(R.id.task1_12);
        task13=(TextView)findViewById(R.id.task1_13);
        task14=(TextView)findViewById(R.id.task1_14);
        task15=(TextView)findViewById(R.id.task1_15);
        task16=(TextView)findViewById(R.id.task1_16);
        task17=(TextView)findViewById(R.id.task1_17);
        task18=(TextView)findViewById(R.id.task1_18);
        task19=(TextView)findViewById(R.id.task1_19);
        task20=(TextView)findViewById(R.id.task1_20);
        task21=(TextView)findViewById(R.id.task1_21);
        task22=(TextView)findViewById(R.id.task1_22);
        task23=(TextView)findViewById(R.id.task1_23);
        task24=(TextView)findViewById(R.id.task1_24);
        task25=(TextView)findViewById(R.id.task1_25);
        task26=(TextView)findViewById(R.id.task1_26);
        task27=(TextView)findViewById(R.id.task1_27);
        task28=(TextView)findViewById(R.id.task1_28);
        task29=(TextView)findViewById(R.id.task1_29);
        task30=(TextView)findViewById(R.id.task1_30);
        task31=(TextView)findViewById(R.id.task1_31);
        task32=(TextView)findViewById(R.id.task1_32);
        ...
        trueAns1=getString(R.string.answerTask1_1);
        trueAns2=getString(R.string.answerTask1_2);
        trueAns3=getString(R.string.answerTask1_3);
        trueAns4=getString(R.string.answerTask1_4);
        trueAns5=getString(R.string.answerTask1_5);
        trueAns6=getString(R.string.answerTask1_6);
        trueAns7=getString(R.string.answerTask1_7);
        trueAns8=getString(R.string.answerTask1_8);
        trueAns9=getString(R.string.answerTask1_9);
        trueAns10=getString(R.string.answerTask1_10);
        trueAns11=getString(R.string.answerTask1_11);
        trueAns12=getString(R.string.answerTask1_12);
        trueAns13=getString(R.string.answerTask1_13);
        trueAns14=getString(R.string.answerTask1_14);
        trueAns15=getString(R.string.answerTask1_15);
        trueAns16=getString(R.string.answerTask1_16);
        trueAns17=getString(R.string.answerTask1_17);
        trueAns18=getString(R.string.answerTask1_18);
        trueAns19=getString(R.string.answerTask1_19);
        trueAns20=getString(R.string.answerTask1_20);
        trueAns21=getString(R.string.answerTask1_21);
        trueAns22=getString(R.string.answerTask1_22);
        trueAns23=getString(R.string.answerTask1_23);
        trueAns24=getString(R.string.answerTask1_24);
        trueAns25=getString(R.string.answerTask1_25);
        trueAns26=getString(R.string.answerTask1_26);
        trueAns27=getString(R.string.answerTask1_27);
        trueAns28=getString(R.string.answerTask1_28);
        trueAns29=getString(R.string.answerTask1_29);
        trueAns30=getString(R.string.answerTask1_30);
        trueAns31=getString(R.string.answerTask1_31);
        trueAns32=getString(R.string.answerTask1_32);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if(ans1.getText().toString().equals(trueAns1)){
                    ...
                    Toast.makeText(Task1Activity.this,"true",Toast.LENGTH_LONG).show();
                }
                else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task1Activity.this,"wrong",Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
