...
public class Task11Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1=(EditText)findViewById(R.id.ansTask11_1);
        ans2=(EditText)findViewById(R.id.ansTask11_2);
        ans3=(EditText)findViewById(R.id.ansTask11_3);
        ans4=(EditText)findViewById(R.id.ansTask11_4);
        ans5=(EditText)findViewById(R.id.ansTask11_5);
        ans6=(EditText)findViewById(R.id.ansTask11_6);
        ans7=(EditText)findViewById(R.id.ansTask11_7);
        ans8=(EditText)findViewById(R.id.ansTask11_8);
        ans9=(EditText)findViewById(R.id.ansTask11_9);
        ans10=(EditText)findViewById(R.id.ansTask11_10);
        ans11=(EditText)findViewById(R.id.ansTask11_11);
        ans12=(EditText)findViewById(R.id.ansTask11_12);
        ans13=(EditText)findViewById(R.id.ansTask11_13);
        ans14=(EditText)findViewById(R.id.ansTask11_14);
        ans15=(EditText)findViewById(R.id.ansTask11_15);
        ans16=(EditText)findViewById(R.id.ansTask11_16);
        ans17=(EditText)findViewById(R.id.ansTask11_17);
        ans18=(EditText)findViewById(R.id.ansTask11_18);
        ans19=(EditText)findViewById(R.id.ansTask11_19);
        ans20=(EditText)findViewById(R.id.ansTask11_20);

        task1=(TextView)findViewById(R.id.task11_1);
        task2=(TextView)findViewById(R.id.task11_2);
        task3=(TextView)findViewById(R.id.task11_3);
        task4=(TextView)findViewById(R.id.task11_4);
        task5=(TextView)findViewById(R.id.task11_5);
        task6=(TextView)findViewById(R.id.task11_6);
        task7=(TextView)findViewById(R.id.task11_7);
        task8=(TextView)findViewById(R.id.task11_8);
        task9=(TextView)findViewById(R.id.task11_9);
        task10=(TextView)findViewById(R.id.task11_10);
        task11=(TextView)findViewById(R.id.task11_11);
        task12=(TextView)findViewById(R.id.task11_12);
        task13=(TextView)findViewById(R.id.task11_13);
        task14=(TextView)findViewById(R.id.task11_14);
        task15=(TextView)findViewById(R.id.task11_15);
        task16=(TextView)findViewById(R.id.task11_16);
        task17=(TextView)findViewById(R.id.task11_17);
        task18=(TextView)findViewById(R.id.task11_18);
        task19=(TextView)findViewById(R.id.task11_19);
        task20=(TextView)findViewById(R.id.task11_20);
        ...
        trueAns1=getString(R.string.answerTask11_1);
        trueAns2=getString(R.string.answerTask11_2);
        trueAns3=getString(R.string.answerTask11_3);
        trueAns4=getString(R.string.answerTask11_4);
        trueAns5=getString(R.string.answerTask11_5);
        trueAns6=getString(R.string.answerTask11_6);
        trueAns7=getString(R.string.answerTask11_7);
        trueAns8=getString(R.string.answerTask11_8);
        trueAns9=getString(R.string.answerTask11_9);
        trueAns10=getString(R.string.answerTask11_10);
        trueAns11=getString(R.string.answerTask11_11);
        trueAns12=getString(R.string.answerTask11_12);
        trueAns13=getString(R.string.answerTask11_13);
        trueAns14=getString(R.string.answerTask11_14);
        trueAns15=getString(R.string.answerTask11_15);
        trueAns16=getString(R.string.answerTask11_16);
        trueAns17=getString(R.string.answerTask11_17);
        trueAns18=getString(R.string.answerTask11_18);
        trueAns19=getString(R.string.answerTask11_19);
        trueAns20=getString(R.string.answerTask11_20);
    }
        ...
        switch (view.getId()) {
            case R.id.btnCheck1:
                if (ans1.getText().toString().equals(trueAns1)) {
                    ...
                    Toast.makeText(Task11Activity.this, "true", Toast.LENGTH_LONG).show();
                } else {
                    task1.setTextColor(getResources().getColor(R.color.colorRed));
                    Toast.makeText(Task11Activity.this, "wrong", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.btnCheck2:
